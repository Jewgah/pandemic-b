...
static std::unordered_map<City,std::string> convert_city_to_string ={
       ...
       static unordered_map<City,unordered_set<City>> connect_city{
       ...
       static unordered_map<City, Color> color_city {
